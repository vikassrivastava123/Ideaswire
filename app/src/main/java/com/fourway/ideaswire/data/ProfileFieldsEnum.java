...
public class ProfileFieldsEnum {
    ...
    public static final String PROFILE_PAGE_CONTACT_US_PARAGRAPH = "Contact_Us_Paragraph_1";
    public static final String PROFILE_PAGE_CONTACT_US_ADDRESS = "Contact_Us_Subheading_2";
    public static final String PROFILE_PAGE_CONTACT_US_EMAIL = "Contact_Us_Paragraph_2";
    public static final String PROFILE_PAGE_CONTACT_US_PHONE_NUMBER = "Contact_Us_Subheading_3";
    public static final String PROFILE_PAGE_CONTACT_US_WEBSITE= "Contact_Us_Paragraph_3";
